...
@Component({
    selector: 'other-invoice-credit-note-create',
    templateUrl: './credit-note-create.component.html',
    styleUrls: ['./credit-note-create.component.scss']
})

export class OtherInvoiceCreateComponent implements OnInit, OnDestroy {
    ...
    createCreditNote() {
        ...
        // });
        this.router.navigateByUrl('/transaction/credit-note/other-invoice/create-list',
    ...
    navToList() {
        this.router.navigate(['/transaction/credit-note/other-invoice/create-list'])
    }
}