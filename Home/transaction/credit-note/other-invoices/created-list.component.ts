...
@Component({
    selector: 'other-invoice-credit-note-created-list',
    templateUrl: './created-list.component.html',

})

export class OtherInvoiceCreatedListComponent implements OnInit {
    ...
    radioSelect() {
        ...
        this.router.navigateByUrl('transaction/credit-note/other-invoice/credit-note-create', { state: { data: this.createData } });
    }
}