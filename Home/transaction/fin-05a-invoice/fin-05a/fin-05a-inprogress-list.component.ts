...
@Component({
    selector: 'fin-05s-inprogress-list',
    templateUrl: './fin-05a-inprogress-list.component.html',
    providers: [NgbModalConfig, NgbModal]
})

export class Fin05aInProgressListComponent implements OnInit {
    ...
    inProgress() {
        this.invoiceDatas = []
        this.filterDatas = []
        this.fin05aService.fetchDataForFin05aInProgress(6, 'APPROVED BY MOH').subscribe(x => {
            this.invoiceDatas = x;
