...
@Component({
    selector: 'FIN-01-Inv-Exception',
    templateUrl: './FIN-01-Inv-Exception.component.html'
})

export class FIN01InvExceptionComponent implements OnInit {
    ...
    radioSelect() {
        ...
        this.router.navigateByUrl('transaction/fin-01-invoice/FIN-01-create', { state: { data: this.createData } });
    }
