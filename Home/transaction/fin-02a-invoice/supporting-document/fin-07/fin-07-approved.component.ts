...
@Component({
  selector: 'fin-07-approved',
  templateUrl: './fin-07-approved.component.html',
  providers: [NgbModalConfig, NgbModal]
})

export class Fin07ApprovedListComponent implements OnInit {
  ...
  selectedIds(selectedIds) {
    ...
    if (this.route.params['_value']['_indicator'] != "undefined") {
      if (this.route.params['_value']['_indicator'] == "new") {
        this.loading = true;
        this.fin02aService.fetchDataForFin07Approved('APPROVED BY MOH', selectedIds).subscribe(fin => {
        ...
        this.fin02aService.fetchDataForFin07ApprovedOlder('APPROVED BY MOH', selectedIds).subscribe(fin => {
