...
@Component({
    selector: 'FIN-08-Inv-Exception',
    templateUrl: './FIN-08-Inv-Exception.component.html'
})

export class FIN08InvExceptionComponent implements OnInit {
    ...
    radioSelect() {
        ...
        this.router.navigateByUrl('transaction/fin-02-invoice/fin-08-create', { state: { data: this.createData } });
    }
