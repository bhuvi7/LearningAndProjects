...
@Component({
    selector: 'fin-08b-create',
    templateUrl: './fin-08b-create.component.html',
    styleUrls: ['./fin-08b-create.component.scss'],
    providers: [NgbModalConfig, NgbModal]
})

export class Fin08bCreateComponent implements OnInit {
    ...
    closeModal() {
        if (this.modalBodyContent == 'Create') { this.createFin08b(); }
    }
    ...
    createFin08b() {
        ...
        this.fin08Service.createFin08b(this.equipmentDatas, this.userId).subscribe(x => {
            this.disableCreate = false
            this.enabler = false
            Swal.fire('', 'Fin 08b created and submitted successfully!!!', 'success').then(x => {
                history.back();
            });
        })
    }
